...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <!-- Begin - top banner -->
        <div class="banner-new-top">
            <div class="banner-new-top-wrapper">
                <div class="container">
                    <div class="col-md-6 padding-y-xl">
                        <h1>Din online dagsorden</h1>
                        <p>Aenean mattis venenatis lacus, vitae varius dui molestie vitae. Proin id lacus.</p>
                        <a class="btn btn-primary" href="#" data-scroll-to="#signup">Prøv <span class="semi-bold">gratis</span></a>
                    </div>
                    <div class="col-md-6">
                        <img src="<?php print $image_path . "banner/laptop.png" ?>" class="banner-new-top-image-laptop" alt=""/>
                    </div>
                </div>
            </div>
        </div>
